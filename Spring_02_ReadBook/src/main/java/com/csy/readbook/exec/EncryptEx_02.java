...
public class EncryptEx_02 {
    public static void main(String[] args) throws FileNotFoundException {
        String propsfile = "./src/main/webapp/WEB-INF/spring/props/" + "db.conn.properties";
         ...
         *      List<> Array<>
         *
         * Map<> type 의 데이터는 Collections(다수의 데이터를 포함하는 데이터) 이지만 Literal 은 아니다
         * Map 에 담긴 데이터를 foreach() 등을 직접 사용하여 확인할 수 없다
         *
         * Map 에 담긴 데이터를 foreach() 를 이용하여 연산을 하고자 할 때는
         * 1. Map 의 key 값을 추출하여 Set 데이터로 변환한다
         *      Map 에서 제공하는 keySet() method 를 사용하여 key 들만 별도로 추출하여 Set 데이터로 변환할 수 있다
        ...
        // 시스템 환경변수 중에 csy.com 변수의 값을 추출(getter)하여 salt 변수에 담는다
        String salt = sysEnvList.get("csy.com");
        System.out.println("=".repeat(100));
        System.out.println("시스템 환경변수 csy.com : " + salt);
