package com.csy.jc.service.impl;

import com.csy.jc.models.BookVO;
import com.csy.jc.models.NaverRestLayout;
import com.csy.jc.service.NaverService;
...
public class NaverServiceImplV1 extends NaverService<BookVO> {
    ...
    /**
     * RestTemplate 을 사용하여 naver 도서 정보 가져오기
     */
    @Override
    public List<BookVO> naverList(String queryString) {
        ...
        restList = restTemp.exchange(restURI, HttpMethod.GET, httpEntity, NaverRestLayout.class);
